...
class DataGenerator {
    ...
    /**
     * Set the locale for generated data (e.g. 'de', 'fr', 'ja', 'en_US').
     * Requires the matching @faker-js/faker locale to be available.
     * @param {string} locale  Faker locale identifier
     */
